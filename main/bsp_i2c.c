...
#define I2C_MASTER_SCL_IO           CONFIG_ESP_I2C_SCL_PIN      /*!< GPIO number used for I2C master clock */
#define I2C_MASTER_SDA_IO           CONFIG_ESP_I2C_SDA_PIN      /*!< GPIO number used for I2C master data  */
